...
pub async fn list_connections(
    ...
    let filtered: Vec<ConnectionResponse> = connections
        ...
        .filter_map(|info| {
            ...
            let user_id_uuid = info
                .user_id
                .as_ref()
                .and_then(|id| uuid::Uuid::parse_str(id).ok());
            let device_id_uuid = info
                .device_id
                .as_ref()
                .and_then(|id| uuid::Uuid::parse_str(id).ok());
            ...
            Some(ConnectionResponse {
                ...
                connected_at: now
                    - chrono::Duration::from_std(connected_duration).unwrap_or_default(),
                last_activity: now
                    - chrono::Duration::from_std(last_activity_duration).unwrap_or_default(),

...
#[cfg(unix)]
pub fn set_resource_limits(max_open_files: u64, max_memory_mb: u64) -> Result<(), ServerError> {
...
#[cfg(windows)]
pub fn set_resource_limits(_max_open_files: u64, _max_memory_mb: u64) -> Result<(), ServerError> {
